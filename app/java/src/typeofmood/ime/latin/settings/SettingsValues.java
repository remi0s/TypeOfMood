...
import typeofmood.ime.compat.AppWorkaroundsUtils;
...
import typeofmood.ime.latin.utils.RunInLocale;
import typeofmood.ime.latin.utils.TargetPackageInfoGetterTask;
...
public class SettingsValues {
    ...
    public SettingsValues(final Context context, final SharedPreferences prefs, final Resources res,
        ...
        mHasKeyboardResize = prefs.getBoolean(DebugSettings.PREF_RESIZE_KEYBOARD, false); //remi0s keyboard height
