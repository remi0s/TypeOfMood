...
import typeofmood.ime.latin.common.ComposedData;
import typeofmood.ime.latin.common.FileUtils;
import typeofmood.ime.latin.define.DecoderSpecificConstants;
import typeofmood.ime.latin.makedict.DictionaryHeader;
import typeofmood.ime.latin.makedict.FormatSpec;
import typeofmood.ime.latin.makedict.UnsupportedFormatException;
import typeofmood.ime.latin.makedict.WordProperty;
import typeofmood.ime.latin.settings.SettingsValuesForSuggestion;
import typeofmood.ime.latin.utils.AsyncResultHolder;
import typeofmood.ime.latin.utils.CombinedFormatUtils;
import typeofmood.ime.latin.utils.ExecutorUtils;
import typeofmood.ime.latin.utils.WordInputEventForPersonalization;
...
abstract public class ExpandableBinaryDictionary extends Dictionary {
    ...
    /**
     * Used by Sketch.
     * {@see https://cs.corp.google.com/#ime/vendor/unbundled_google/packages/LatinIMEGoogle/tools/sketch/ime-simulator/src/com/ime/inputmethod/sketch/imesimulator/ImeSimulator.java&q=updateEntriesForInputEventsCallback&l=286}
     */
    @UsedForTesting
