...
package typeofmood.ime.latin.suggestions;
...
import typeofmood.ime.keyboard.MoreKeysPanel;
...
public final class SuggestionStripView extends RelativeLayout implements OnClickListener,
    ...
    public interface Listener {
        ...
        public void pickSuggestionManually(SuggestedWords.SuggestedWordInfo word);
...
//        keyboardAttr.recycle();
    ...
    private final MoreSuggestionsListener mMoreSuggestionsListener = new MoreSuggestionsListener() {
        @Override
        public void onSuggestionSelected(final SuggestedWords.SuggestedWordInfo wordInfo) {
...
//            mNotificationHelperPhysical.getManager().notify(mNotificationHelperPhysical.notification_id, nbPhysical.build());
            ...
            NotificationCompat.Builder nb=new NotificationCompat.Builder(getContext(),"TypeOfMoodChannelID");
        ...
        if (tag instanceof Integer) {
            ...
            final SuggestedWords.SuggestedWordInfo wordInfo = mSuggestedWords.getInfo(index);
            mListener.pickSuggestionManually(wordInfo);
        }
    }
