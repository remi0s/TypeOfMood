...
package typeofmood.ime.latin.inputlogic;
...
import typeofmood.ime.latin.Dictionary;
import typeofmood.ime.latin.DictionaryFacilitator;
import typeofmood.ime.latin.LastComposedWord;
import typeofmood.ime.latin.LatinIME;
import typeofmood.ime.latin.NgramContext;
import typeofmood.ime.latin.RichInputConnection;
import typeofmood.ime.latin.Suggest;
import typeofmood.ime.latin.SuggestedWords;
import typeofmood.ime.latin.WordComposer;
import typeofmood.ime.compat.SuggestionSpanUtils;
...
import typeofmood.ime.latin.settings.SpacingAndPunctuations;
import typeofmood.ime.latin.suggestions.SuggestionStripViewAccessor;
import typeofmood.ime.latin.utils.AsyncResultHolder;
import typeofmood.ime.latin.utils.InputTypeUtils;
import typeofmood.ime.latin.utils.RecapitalizeStatus;
import typeofmood.ime.latin.utils.StatsUtils;
import typeofmood.ime.latin.utils.TextRange;
...
public final class InputLogic {
     ...
     *     {@link typeofmood.ime.keyboard.KeyboardSwitcher#getKeyboardShiftMode()}
     * @return the complete transaction object
     */
    ...
    public void performUpdateSuggestionStripSync(final SettingsValues settingsValues,
        ...
        mInputLogicHandler.getSuggestedWords(inputStyle, SuggestedWords.NOT_A_SEQUENCE_NUMBER,
                new Suggest.OnGetSuggestedWordsCallback() {
                    @Override
     ...
     *      SuggestedWords.SuggestedWordInfo, SuggestedWords)}.
