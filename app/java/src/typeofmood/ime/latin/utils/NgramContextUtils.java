...
public final class NgramContextUtils {
    ...
    public static NgramContext getNgramContextFromNthPreviousWord(final CharSequence prev,
        ...
        final NgramContext.WordInfo[] prevWordsInfo =
                new NgramContext.WordInfo[DecoderSpecificConstants.MAX_PREV_WORD_COUNT_FOR_N_GRAM];
        Arrays.fill(prevWordsInfo, NgramContext.WordInfo.EMPTY_WORD_INFO);
