...
public final class StringUtils {
    ...
    // Taken from ime.text.TextUtils. We are extensively using this method in many places,
    // some of which don't have the ime libraries available.
    /**
    ...
    // Taken from ime.text.TextUtils to cut the dependency to the Android framework.
    /**
