...
package typeofmood.ime.latin.setup;
...
public final class SetupWizardActivity extends Activity implements View.OnClickListener {
    ...
    private static final int STEP_LAUNCHING_USER_SETTINGS = 7;
    private static final String MY_PREFS_NAME="user_info_finished_clicked";
    ...
    void invokeUserInfo(){
        Intent intent2 = new Intent(getApplicationContext(), UserInfoConfiguration.class);
        startActivity(intent2); //remi0s
    }
    boolean isUserInfoFinishedPressed(){
        SharedPreferences pref = getApplicationContext().getSharedPreferences(MY_PREFS_NAME, MODE_PRIVATE);
        SharedPreferences.Editor editor = pref.edit();
        boolean isClicked= pref.getBoolean("isClicked", false);
        return isClicked;
    }
    ...
    private int determineSetupStepNumberFromLauncher() {
        ...
        if (stepNumber == STEP_3) {
            return STEP_WELCOME;//STEP_LAUNCHING_IME_SETTINGS
        }
        return stepNumber;
    }
    ...
    private int determineSetupStepNumber() {
        ...
        if(isUserInfoFinishedPressed()){ //remi0s
            return STEP_4;
        }
        return STEP_3;
    }
    ...
    public void onBackPressed() {
        ...
        if(android.os.Build.VERSION.SDK_INT >= 21) //remi0s
        {
            finishAndRemoveTask();
        }
        super.onBackPressed();
