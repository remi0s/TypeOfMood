...
import typeofmood.ime.compat.InputConnectionCompatUtils;
import typeofmood.ime.latin.common.Constants;
import typeofmood.ime.latin.common.StringUtils;
import typeofmood.ime.latin.common.UnicodeSurrogate;
import typeofmood.ime.latin.inputlogic.PrivateCommandPerformer;
import typeofmood.ime.latin.settings.SpacingAndPunctuations;
import typeofmood.ime.latin.utils.CapsModeUtils;
import typeofmood.ime.latin.utils.DebugLogUtils;
import typeofmood.ime.latin.utils.NgramContextUtils;
import typeofmood.ime.latin.utils.ScriptUtils;
import typeofmood.ime.latin.utils.SpannableStringUtils;
    ...
    public void commitText(final CharSequence text, final int newCursorPosition) {
        ...
        if (isConnected()) {
            ...
            for (final CharacterStyle span : spans) {
                ...
                // See com.ime.latin.common.Constants.UnicodeSurrogate
