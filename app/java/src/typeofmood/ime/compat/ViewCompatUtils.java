...
package typeofmood.ime.compat;

import android.view.View;

import java.lang.reflect.Method;

// TODO: Use {@link ime.support.v4.view.ViewCompat} instead of this utility class.
// Currently {@link #getPaddingEnd(View)} and {@link #setPaddingRelative(View,int,int,int,int)}
// are missing from ime-support-v4 static library in KitKat SDK.
