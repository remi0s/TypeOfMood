...
package typeofmood.ime.keyboard;
...
import typeofmood.ime.latin.RichInputMethodSubtype;
import typeofmood.ime.latin.SuggestedWords;
import typeofmood.ime.accessibility.AccessibilityUtils;
import typeofmood.ime.accessibility.MainKeyboardAccessibilityDelegate;
import typeofmood.ime.annotations.ExternallyReferenced;
import typeofmood.ime.keyboard.internal.DrawingPreviewPlacerView;
import typeofmood.ime.keyboard.internal.DrawingProxy;
import typeofmood.ime.keyboard.internal.GestureFloatingTextDrawingPreview;
import typeofmood.ime.keyboard.internal.GestureTrailsDrawingPreview;
import typeofmood.ime.keyboard.internal.KeyDrawParams;
import typeofmood.ime.keyboard.internal.KeyPreviewChoreographer;
import typeofmood.ime.keyboard.internal.KeyPreviewDrawParams;
import typeofmood.ime.keyboard.internal.KeyPreviewView;
import typeofmood.ime.keyboard.internal.MoreKeySpec;
import typeofmood.ime.keyboard.internal.NonDistinctMultitouchHelper;
import typeofmood.ime.keyboard.internal.SlidingKeyInputDrawingPreview;
import typeofmood.ime.keyboard.internal.TimerHandler;
import typeofmood.ime.R;
import typeofmood.ime.latin.common.Constants;
import typeofmood.ime.latin.common.CoordinateUtils;
import typeofmood.ime.latin.settings.DebugSettings;
import typeofmood.ime.latin.utils.LanguageOnSpacebarUtils;
import typeofmood.ime.latin.utils.TypefaceUtils;

import typeofmood.ime.latin.LatinIME; //remi0s
...
public final class MainKeyboardView extends KeyboardView implements DrawingProxy,
    ...
    private LatinIME mLatinIme; //remi0s
    ...
    private void installPreviewPlacerView() {
        ...
        // Note: It'd be very weird if we get null by ime.R.id.content.
        if (windowContentView == null) {
            Log.w(TAG, "Cannot find ime.R.id.content view to add DrawingPreviewPlacerView");
            return;
        }
