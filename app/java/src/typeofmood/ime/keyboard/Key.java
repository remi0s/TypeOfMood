...
import typeofmood.ime.keyboard.internal.KeySpecParser;
import typeofmood.ime.keyboard.internal.KeyStyle;
import typeofmood.ime.keyboard.internal.KeyVisualAttributes;
import typeofmood.ime.keyboard.internal.KeyboardIconsSet;
import typeofmood.ime.keyboard.internal.KeyboardParams;
import typeofmood.ime.keyboard.internal.KeyboardRow;
...
public class Key implements Comparable<Key> {
    ...
    public Key(@Nullable final String label, final int iconId, final int code,
        ...
        mCode = code;
        mEnabled = (code != Constants.CODE_UNSPECIFIED);
        mIconId = iconId;
    ...
    public final boolean isShift() {
        return mCode == Constants.CODE_SHIFT;
    }

    public final boolean isModifier() {
        return mCode == Constants.CODE_SHIFT || mCode == Constants.CODE_SWITCH_ALPHA_SYMBOL;
    }
    ...
    public final int getAltCode() {
        final OptionalAttributes attrs = mOptionalAttributes;
        return (attrs != null) ? attrs.mAltCode : Constants.CODE_UNSPECIFIED;
    }
    ...
    public static class Spacer extends Key {
        ...
        protected Spacer(final KeyboardParams params, final int x, final int y, final int width,
                final int height) {
            super(null /* label */, KeyboardIconsSet.ICON_UNDEFINED, Constants.CODE_UNSPECIFIED, null /* outputText */,
