...
package typeofmood.ime.keyboard.internal;
...
public final class KeyPreviewDrawParams {
    ...
    public KeyPreviewDrawParams(final TypedArray mainKeyboardViewAttr) {
        mPreviewOffset = mainKeyboardViewAttr.getDimensionPixelOffset(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewOffset, 0);
        mPreviewHeight = mainKeyboardViewAttr.getDimensionPixelSize(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewHeight, 0);
        mPreviewBackgroundResId = mainKeyboardViewAttr.getResourceId(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewBackground, 0);
        mLingerTimeout = mainKeyboardViewAttr.getInt(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewLingerTimeout, 0);
        mShowUpAnimatorResId = mainKeyboardViewAttr.getResourceId(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewShowUpAnimator, 0);
        mDismissAnimatorResId = mainKeyboardViewAttr.getResourceId(
                typeofmood.ime.R.styleable.MainKeyboardView_keyPreviewDismissAnimator, 0);
    }
